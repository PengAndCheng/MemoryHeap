...
//xBlockSize的高位掩码使用了这个值进行初始化，其大小决定了最小申请尺寸的大小 如果是8最大申请尺寸就是127，自己解读源码理解的，网上未看到说明
